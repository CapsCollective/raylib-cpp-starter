...
ifeq ($(OS), Windows_NT)
	...
	dir include
	xcopy "vendor\raylib-cpp\vendor\raylib\src\raylib.h" "include" /Y
	xcopy "vendor\raylib-cpp\vendor\raylib\src\raymath.h" "include" /Y
	xcopy "vendor\raylib-cpp\include\*.hpp" "include" /Y
...
ifeq ($(OS), Windows_NT)
	...
	xcopy "vendor\raylib-cpp\vendor\raylib\$(libGenDirectory)\libraylib.a" "lib\$(platform) /Y"
else
	mkdir $(mkdirOptions) lib/$(platform)
